...
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (utilisateur == null) {
			...
			request.getRequestDispatcher("/JSP_pages/account/register.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			new FormAppException(AppException.ALTERED_DATA_ERROR + AppException.FORBIDDEN_CONNECTION_ERROR, request, response).redirigerPageErreur();
		}
	}
