	                            ...
	                            <div class="card-block">
	                                ...
	                                <div class="row">
	                                	 <div class="button-box col-lg-12">
									         <a href="account/modifyAccount" class="btn btn-info" role="button">Modifier les informations</a>
									         <a href="account/modifyPassword" class="btn btn-info" role="button">Modifier le mot de passe</a>
									   	 </div> 
	                                </div>	
